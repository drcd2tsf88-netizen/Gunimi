...
import GunimiSkeleton
from "@/components/ui/GunimiSkeleton";
...
export default function GunimiActivityFeed({
  items,
  loading = false,
  badge,
  feedTitle,
  ...
  return (
    <GunimiSection>
      ...
      >
        {loading &&
          [1, 2, 3].map((i) => (
            <GunimiSkeleton key={i} />
          ))}

        {!loading && items.length === 0 && (
          <GunimiCard className="p-10 text-center">
