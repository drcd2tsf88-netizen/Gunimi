...
// ─────────────────────────────────────────────────────────────
// GunimiInput — Titanium Glass input field.
// Focus ring glows with primary color. No hard borders.
// ─────────────────────────────────────────────────────────────

export type GunimiInputProps = React.InputHTMLAttributes<HTMLInputElement>;

const GunimiInput = React.forwardRef<HTMLInputElement, GunimiInputProps>(
  ({ className, ...props }, ref) => {
    return (
...
GunimiInput.displayName = "GunimiInput";
export default GunimiInput;
