...
// ─────────────────────────────────────────────────────────────
// GunimiButton — Gunimi primary action component.
//
...
type GunimiButtonProps = React.ButtonHTMLAttributes<HTMLButtonElement> & {
  loading?: boolean;
  variant?: "primary" | "secondary" | "ghost" | "danger";
};

export default function GunimiButton({
  children,
  className,
  loading,
  variant = "primary",
  ...
  const variants: Record<NonNullable<GunimiButtonProps["variant"]>, string> = {
    primary: [
