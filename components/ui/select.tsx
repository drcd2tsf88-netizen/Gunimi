...
function SelectItem({
  ...
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "relative flex w-full cursor-default items-center gap-2 rounded-lg py-2 pr-8 pl-3 text-xs text-white outline-hidden select-none transition-all duration-200 focus:bg-white/[0.08] focus:text-white data-[highlighted]:bg-white/[0.08] data-[highlighted]:text-white data-[state=checked]:bg-white/[0.12] data-[state=checked]:text-white data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
