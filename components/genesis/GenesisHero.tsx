...
export function GenesisHero() {
  ...
  return (
    ...
    >
      ...
      >
        <AiCore size={280} showRings showParticles intensity="subtle" />
      </FadeIn>
            ...
            <div className="flex flex-col items-center gap-4 lg:items-start">
              ...
              <div className="flex flex-col gap-1">
                <Reveal delay={0.2} duration={0.8} y={20}>
                  <h1 className="text-[24px] font-semibold leading-[1.05] tracking-[-0.03em] text-[var(--g-text)] sm:text-[32px] md:text-[52px] md:tracking-[-0.025em]">
                    {t("headlineLine1")}
                  </h1>
                </Reveal>
                <Reveal delay={0.32} duration={0.8} y={20}>
                  {/* Line 2 in text-2 (#C8CDD8) — cadence without gradient */}
                  <span className="block text-[24px] font-semibold leading-[1.05] tracking-[-0.03em] text-[var(--g-text-2)] sm:text-[32px] md:text-[52px] md:tracking-[-0.025em]">
                    {t("headlineLine2")}
                  </span>
                </Reveal>
              </div>
              ...
              <Reveal delay={0.9} duration={0.6} y={8}>
                <div className="flex flex-col items-center gap-3 sm:flex-row sm:gap-4 lg:items-start">
                  <Link
                    href="/register"
                    className={cn(
                      "inline-flex w-full items-center justify-center rounded-[12px] px-6 py-3 sm:w-auto",
