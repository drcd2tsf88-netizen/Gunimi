...
import { AlertCircle, CheckSquare2, Clock, Plus, User, X } from "lucide-react";
  ...
  function handleCreate() {
    ...
    startCreate(async () => {
      ...
      if (result) {
        ...
        setNewTitle("");
        setAdding(false);
        toast.success(tFocus("taskCreated"), { id: "deal-task-create" });
      } else {
        toast.error(tFocus("taskCreateFailed"), { id: "deal-task-create" });
      }
    });
  }
