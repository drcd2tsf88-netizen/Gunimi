...
export type TaskTagsMap = Record<string, WorkspaceTag[]>;

export async function getWorkspaceTaskTagsMap(): Promise<TaskTagsMap> {
  try {
    ...
    logger.error("getWorkspaceTaskTagsMap failed:", err);
    return {};
  }
}
